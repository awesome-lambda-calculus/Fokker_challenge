...
theorem mem_terms_blc_lt_26_iff (M : Term String)
  ...
  LcAt 0 M = false \/ M.every_bvar_used \/ M.no_duplicate \/ M.isNamedOfXY \/ M.tailOk \/ M.rigid \/ M.argOk \/ M.properClosedNoParens \/ M ∈ fokkerUndecidedTerms \/ M ∈ fokkerUpdatedOpenCerts.map Prod.fst \/ M = db! "λλ0(λλ102)" \/ M = db! "λλ0(λλ201)" \/ M = db! "λλλ0(λ102)" \/ M = db! "λλλ0(λ201)" := by
